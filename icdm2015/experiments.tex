...
\caption{Example of NSF Abstracts: (right) example of an NSF proposal title found by our approach to be a more diverse title (inter-disciplinary proposal); (left) example of an NSF proposal mostly centered on a single area.}
