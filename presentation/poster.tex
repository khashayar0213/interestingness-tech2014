...
\hline
\rowcolor{lightestyellow} \cellcolor{yellow} {\bf iPhone} & 111 & 5 & 1\\
\rowcolor{lightestyellow} \cellcolor{yellow} {\bf Apple} & 80 & 50 & 0\\
\rowcolor{lightestyellow} \cellcolor{yellow} {\bf Batman} & 7 & 0 & 65\\
\rowcolor{lightestyellow} \cellcolor{yellow} {\bf New} & 325 & 240 & 165\\
\rowcolor{lightestyellow} \cellcolor{yellow} {\bf Esoteric} & 0 & 0 & 1
\end{tabular}
\end{center}
...
\smallskip
\fcolorbox{reddishyellow}{lightestyellow}{
\parbox{0.45\textwidth}{
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \headerbox{JSD Example: Two Gaussians}{name=dms,column=1,below=regret}{
\begin{center}\fcolorbox{reddishyellow}{white}{\includegraphics[width=0.95\textwidth]{figures/DiversityCombined.jpg}}
\end{center}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \headerbox{1. Fixing Sample Size Bias}{name=logloss,column=2,below=regret}{
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\fboxsep=2pt
{\bf Problem:} Some of the row vectors in $\cM$ may not have
  enough data points to properly estimate the topic distribution.
\vspace{-2mm}\begin{center}\fcolorbox{reddishyellow}{lightestyellow}{
...
\hline 
\rowcolor{lightestyellow} \cellcolor{yellow}{\bf JSD}         &$\mathbf{0.714}$&$0.597$&$0.650$& $\mathbf{0.8828}$\\
\rowcolor{lightestyellow} \cellcolor{yellow}{\bf RAE}             &$0.676$&$\mathbf{0.666}$&$\mathbf{0.671}$&$0.8809$ \\
\rowcolor{lightestyellow} \cellcolor{yellow}{\bf LSI}             &$0.676$&$0.633$&$0.654$&$0.8778$\\
\end{tabular}
\end{center}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\headerbox{2. Capturing Topic Similarity}{name=entropy,column=1,below=dms,above=results}{
\fboxsep=2pt
...
\begin{tabular}{c|ccc}
\rowcolor{yellow} \cellcolor{lightyellow}
$\cS$& {\it Phones} & {\it Computers} & {\it Movies}\\
\hline
\rowcolor{lightestyellow} \cellcolor{yellow} {\it Phones} & \cellcolor{brightyellow} 0.7 & \cellcolor{lightyellow} 0.25 & 0.05\\
\hline
\rowcolor{lightestyellow} \cellcolor{yellow} {\it Computers} & \cellcolor{lightyellow} 0.15 & \cellcolor{brightyellow} 0.8 & 0.05\\
\hline
\rowcolor{lightestyellow} \cellcolor{yellow} {\it Movies} & 0.025 & 0.025 & \cellcolor{brightyellow} 0.95 
\end{tabular}
\end{center}

{\bf Problem:} Capture relations between topics.


\vspace{-2mm}\begin{center}\fcolorbox{reddishyellow}{lightestyellow}{
\parbox{0.95\textwidth}{
Given $P_i$, we take $\tilde{P_i}=P_i\cS^T$, which
