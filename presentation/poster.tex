...
\fcolorbox{yellow}{white}{\includegraphics[width=0.95\textwidth]{figures/interesting.png}}
\end{center}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
 }
...
\begin{multicols}{2}
\begin{center}\fcolorbox{yellow}{white}{\includegraphics[width=25mm]{figures/eyeshadow-iphone-case.jpg}}
\end{center}
...
\begin{multicols}{2}
\begin{center}\fcolorbox{yellow}{white}{\includegraphics[width=25mm]{figures/horn-iphone-speaker.jpg}} 
\end{center}
...
\begin{multicols}{2}
\begin{center}\fcolorbox{yellow}{white}{\includegraphics[width=25mm]{figures/geeky-clock.jpg}}
\end{center}
...
Each word in the vocabulary $V$ is mapped to a {\bf probability
...
\medskip
We chose to use {\bf topic modeling} where $T$ is the set of
...
\begin{enumerate}
\item How should the Reader choose $P_{i}$ given $W$, knowing
  $\cM_{|V|\times|T|}$?
\vspace{-1mm}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\headerbox{Jensen-Shannon Information Diversity}{name=regret,column=1,span=2,below=reader}{
\begin{multicols}{2}
\fboxsep=2pt
\begin{center}\fcolorbox{yellow}{white}{
...
\vspace{-5mm}\begin{center}\fcolorbox{yellow}{white}{
...
\fcolorbox{yellow}{white}{\includegraphics[width=0.24\textwidth]{figures/phonecases-comparison-kopia.png}
\includegraphics[width=0.24\textwidth]{figures/nsf-comparison-kopia.png}}
{\bf Supervised Results}
\fcolorbox{yellow}{white}{\begin{tabular}{|l|c|c|c|c|}
\hline
